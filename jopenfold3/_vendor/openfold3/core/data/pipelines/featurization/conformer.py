...
from jopenfold3._vendor.openfold3.core.data.primitives.structure.component import PERIODIC_TABLE
from jopenfold3._vendor.openfold3.core.model.structure.diffusion_module import centre_random_augmentation
