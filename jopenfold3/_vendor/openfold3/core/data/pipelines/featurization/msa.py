...
from jopenfold3._vendor.openfold3.core.data.primitives.featurization.msa import (
...
from jopenfold3._vendor.openfold3.core.data.primitives.sequence.msa import MsaArrayCollection
