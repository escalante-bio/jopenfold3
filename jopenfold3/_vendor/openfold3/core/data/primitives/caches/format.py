...
from jopenfold3._vendor.openfold3.core.data.primitives.caches.lmdb import LMDBDict
...
class PreprocessingDataCache:
    ...
    def to_json(self, file: Path) -> None:
        ...
        from jopenfold3._vendor.openfold3.core.data.io.dataset_cache import write_datacache_to_json
...
class DatasetCache:
    ...
    def _parse_structure_data_lmdb(
        ...
        from jopenfold3._vendor.openfold3.core.data.primitives.caches.lmdb import (
            LMDBDict,
        )
