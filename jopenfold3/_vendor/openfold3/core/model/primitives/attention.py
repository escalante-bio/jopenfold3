...
from jopenfold3._vendor.openfold3.core.kernels.cueq_utils import is_cuequivariance_available
from jopenfold3._vendor.openfold3.core.utils.checkpointing import get_checkpoint_fn
from jopenfold3._vendor.openfold3.core.utils.tensor_utils import flatten_final_dims
...
def _deepspeed_evo_attn(
    ...
    Args:
        ...
        biases:
            List of biases that broadcast to [*, H, Q, K]
    """
    from jopenfold3._vendor.openfold3 import hacks
