...
from jopenfold3._vendor.openfold3.core.model.primitives import (
    Attention,
    GlobalAttention,
    LayerNorm,
    Linear,
)
from jopenfold3._vendor.openfold3.core.model.primitives.attention import (
    attention_chunked_trainable,
    softmax_no_cast,
)
from jopenfold3._vendor.openfold3.core.utils.checkpointing import get_checkpoint_fn
from jopenfold3._vendor.openfold3.core.utils.chunk_utils import chunk_layer
from jopenfold3._vendor.openfold3.core.utils.tensor_utils import flatten_final_dims, permute_final_dims

triton_is_installed = importlib.util.find_spec("triton") is not None
if triton_is_installed:
    from jopenfold3._vendor.openfold3.core.kernels.triton.fused_softmax import fused_softmax
