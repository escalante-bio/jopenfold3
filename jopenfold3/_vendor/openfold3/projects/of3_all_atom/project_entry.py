...
from jopenfold3._vendor.openfold3.core.config.config_utils import load_yaml
from jopenfold3._vendor.openfold3.projects.of3_all_atom.config.model_config import model_config
from jopenfold3._vendor.openfold3.projects.of3_all_atom.runner import OpenFold3AllAtom
...
class OF3ProjectEntry:
    ...
    model_preset_yaml = (
        importlib.resources.files("jopenfold3._vendor.openfold3.projects.of3_all_atom.config")
