...
from jopenfold3._vendor.openfold3.core.data.framework.data_module import DataModuleConfig
from jopenfold3._vendor.openfold3.projects.of3_all_atom.config.dataset_configs import TrainingDatasetSpec
