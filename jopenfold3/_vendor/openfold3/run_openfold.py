...
from jopenfold3._vendor.openfold3.core.config import config_utils
from jopenfold3._vendor.openfold3.entry_points.import_utils import _torch_gpu_setup
...
def train(runner_yaml: Path, seed: int | None = None, data_seed: int | None = None):
    ...
    _torch_gpu_setup()
    from jopenfold3._vendor.openfold3.entry_points.experiment_runner import (
